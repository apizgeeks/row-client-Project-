...
VOID	CRYLHumanInventoryFrameDlg::InitCtrl() 
{
	...
	m_pTabButton->AttachTabButton( CRYLStringTable::m_strString[ 2080 ], 4 ) ;
	// 소셜모션
	...
	switch ( CRYLGameData::Instance()->m_dwClientRace )
	{
		case CClass::RaceType::HUMAN:
		{
			...
			m_pHumanInvenPanel->SetWidth( 256 ) ;
		...
		case CClass::RaceType::AKHAN:
		{
			...
			m_pAkhanInvenPanel->SetWidth( 256 ) ;
	...
	m_pSocialActionPanel->SetWidth( 256 ) ;
