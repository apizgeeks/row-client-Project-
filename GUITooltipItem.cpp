		...
		*/
		...
		for(int nIndex = 0; nIndex < Item::Attribute::MAX_ATTRIBUTE_NUM; ++nIndex)
		{
			if ( attribute[ Item::Attribute::Type(nIndex)] )
			{
				...
				case Item::Attribute::DARKNESS:		strcpy(strText, CRYLStringTable::m_strString[3554]);	break;
				default:	continue;
				}
		...
		if ( attribute[ Item::Attribute::Type(i)] )
		{
			switch (i)
			{
				...
				case Item::Attribute::DARKNESS:
					sprintf(strText, "%s%d", CRYLStringTable::m_strString[3554], attribute[ Item::Attribute::Type(i)] );
					break;
