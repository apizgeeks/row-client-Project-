...
VOID CRYLLoginDlg::InitCtrl ()
{
	...
	m_pLoginBtn->SetLeft( 53 ) ;
	m_pLoginBtn->SetTop( 147 ) ;
	...
	m_pLoginBtn->AttachButtonImage( pSprite, pRYLButtonRect->GetDefaultButtonNormalRect( 4 ), CRYLImageCabinet::EDCT_BUTTON_NORMAL ) ;
	m_pLoginBtn->AttachButtonImage( pSprite, pRYLButtonRect->GetDefaultButtonDownRect( 4 ), CRYLImageCabinet::EDCT_BUTTON_DOWN ) ;
	m_pLoginBtn->AttachButtonImage( pSprite, pRYLButtonRect->GetDefaultButtonUpRect( 4 ), CRYLImageCabinet::EDCT_BUTTON_UP ) ;
	...
	m_pIDEdit->SetLeft( 88 ) ;
	m_pIDEdit->SetTop( 55 ) ;
	m_pIDEdit->SetWidth( 121 ) ;
	m_pIDEdit->SetHeight( 14 ) ;
	m_pIDEdit->SetColor( 0xff000000) ;
	m_pIDEdit->SetFontColor( 0xffffffff ) ;
	...
	m_pPassWordEdit->SetLeft( 88 ) ;
	m_pPassWordEdit->SetTop( 88 ) ;
	m_pPassWordEdit->SetWidth( 121 ) ;
	m_pPassWordEdit->SetHeight( 14 ) ;
	...
	m_pIDSaveCheckBox->SetLeft( 195 ) ;
	m_pIDSaveCheckBox->SetTop( 115 ) ;
