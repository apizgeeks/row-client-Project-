...
VOID	CRYLRankingDlg::InitCtrl() 
{
	...
	switch( CRYLGameData::Instance()->m_dwClientRace )
	{
		case CClass::RaceType::HUMAN : 
		{
			...
			m_pClassCBBox->AddItem( CRYLStringTable::m_strString[ 457 ], 0xffffffff, 0xff00ffff, 0xffffffff ) ;
			...
			m_pClassCBBox->AddItem( CRYLStringTable::m_strString[ 460 ], 0xffffffff, 0xff00ffff, 0xffffffff ) ;
			m_pClassCBBox->AddItem( CRYLStringTable::m_strString[ 461 ], 0xffffffff, 0xff00ffff, 0xffffffff ) ;
		...
		{
			m_pClassCBBox->AddItem( CRYLStringTable::m_strString[ 2227 ], 0xffffffff, 0xff00ffff, 0xffffffff ) ;
			m_pClassCBBox->AddItem( CRYLStringTable::m_strString[ 469 ], 0xffffffff, 0xff00ffff, 0xffffffff ) ;
			m_pClassCBBox->AddItem( CRYLStringTable::m_strString[ 470 ], 0xffffffff, 0xff00ffff, 0xffffffff ) ;
			m_pClassCBBox->AddItem( CRYLStringTable::m_strString[ 471 ], 0xffffffff, 0xff00ffff, 0xffffffff ) ;
			m_pClassCBBox->AddItem( CRYLStringTable::m_strString[ 472 ], 0xffffffff, 0xff00ffff, 0xffffffff ) ;
			m_pClassCBBox->AddItem( CRYLStringTable::m_strString[ 473 ], 0xffffffff, 0xff00ffff, 0xffffffff ) ;
			m_pClassCBBox->AddItem( CRYLStringTable::m_strString[ 474 ], 0xffffffff, 0xff00ffff, 0xffffffff ) ;
			break ;
		}
	}
	...
	m_pClassCBBox->SetTop( 46 ) ;
	m_pClassCBBox->SetWidth( 72 ) ;
	...
	m_pClassCBBox->GetButton()->SetInstance( RYLRANKINGDLG::RANKING_COMBO ) ;
	...
	CGMImageDib*	pImageDIB = NULL ;
	CRYLImage*		pImage	  = NULL ;
	CRYLSpriteList::Instance()->CreateGMImage( 77, 148, &pImageDIB ) ;
	pImageDIB->ClearbyColor( 0x00000000 ) ;
	if( CClass::RaceType::HUMAN == CRYLGameData::Instance()->m_dwClientRace )
	{
		pImageDIB->MakeFrameRect( 1, 1, 76, 147, 0xff959595, 0xff000000,  1 ) ;
	}
	else
	{
		pImageDIB->MakeFrameRect( 1, 1, 76, 116, 0xff959595, 0xff000000,  1 ) ;
	}
	pImage = CRYLImageManager::Instance()->CreateRYLImage() ;
	pImage->LoadFromImage( pImageDIB ) ;
	CRYLImageManager::s_pDefaultImageCabinet->AddRYLImage( pImage ) ;
...
VOID	CRYLRankingDlg::DlgClick( CGMUIObject* Sender, INT X, INT Y )
{
	...
	switch( Sender->GetInstance() )
	{
		...
		case RYLRANKINGDLG::RANKING_COMBO :
			//g_RankingDlg->InsertDataListbox( g_RankingDlg->m_pClassCBBox->GetMenu()->GetItemIndex() ) ;
			break ;
			...
			switch( CRYLGameData::Instance()->m_dwClientRace )
			{
				case CClass::RaceType::HUMAN : 
				{
					switch ( g_RankingDlg->m_pClassCBBox->GetMenu()->GetItemIndex() )
					{
						...
						case 4 :/*아처*/		g_RankingDlg->m_iClass = 8 ; 	break ;
						case 5 :/*소서러*/		g_RankingDlg->m_iClass = 9 ; 	break ;
						case 6 :/*인챈터*/		g_RankingDlg->m_iClass = 10 ; 	break ;
						case 7 :/*프리스트*/	g_RankingDlg->m_iClass = 11 ; 	break ;
						case 8 :/*클레릭*/		g_RankingDlg->m_iClass = 12 ; 	break ;
					}
					break ;
				}
				...
				case CClass::RaceType::AKHAN : 
				{
					...
					{
						case 0 :/*전체순위*/	g_RankingDlg->m_iClass = 0 ; 	break ;
						case 1 :/*템플러*/		g_RankingDlg->m_iClass = 19 ; 	break ;
						case 2 :/*어태커*/		g_RankingDlg->m_iClass = 20 ; 	break ;
						case 3 :/*거너*/		g_RankingDlg->m_iClass = 21 ; 	break ;
						case 4 :/*룬오프*/		g_RankingDlg->m_iClass = 22 ; 	break ;
						case 5 :/*라이프오프*/	g_RankingDlg->m_iClass = 23 ; 	break ;
						case 6 :/*쉐도우오프*/	g_RankingDlg->m_iClass = 24 ; 	break ;
					}
					break ;
				}
			}
